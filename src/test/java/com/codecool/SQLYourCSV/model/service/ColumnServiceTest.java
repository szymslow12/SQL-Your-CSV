...
class ColumnServiceTest {
    ...
    @Test
    void shouldGetColumnByNameThrowExceptionWhenPassedColumnNameIsNull() {
        assertThrows(IllegalArgumentException.class,
            () -> service.getColumnByName(null, getColumnsList(10)));
    }


    @Test
    void shouldGetColumnByNameThrowExceptionWhenColumnsListIsNull() {
        assertThrows(IllegalArgumentException.class,
    ...
    @Test
    void shouldGetColumnByIndexThrowExceptionWhenIndexIsZero() {
        assertThrows(IllegalArgumentException.class,
